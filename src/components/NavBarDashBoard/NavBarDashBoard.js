    ...
    return (
        <div className={`sideMenu ${active ? 'active' : undefined}`}>
            <Link to="/" className="logo">
                ...
                <span className={`bg-gradient-to-r from-[#432371] to-[#faae7b] inline-block text-transparent bg-clip-text font-lobster font-normal ${active ? 'md:hidden' : 'text-7xl'} md:flex hidden`}>BCU</span>
            </Link>
            <ul className="nav">
